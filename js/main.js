...
if (localColor !== null) {
  ...
  document
    .querySelector(`.settings-box .colors li[data-color="${localColor}"]`)
...
const randomButtons = document.querySelectorAll(
  ".settings-box .option-box:nth-of-type(2) button"
);
...
if (localBackground !== null) {
  ...
  document
    .querySelector(
      `.settings-box .option-box:nth-of-type(2) button[data-background="${localBackground}"]`
    )
    .classList.add("active");
} else {
  randomButtons.forEach((el) => el.classList.remove("active"));
  document
    .querySelector(
      '.settings-box .option-box:nth-of-type(2) button[data-background="yes"]'
    )
    .classList.add("active");
}
...
const bulletsButtons = document.querySelectorAll(
  ".settings-box .option-box:nth-of-type(3) button"
);
...
if (localBullets !== null) {
  ...
  document
    .querySelector(
      `.settings-box .option-box:nth-of-type(3) button[data-bullets="${localBullets}"]`
    )
    .classList.add("active");
  ...
  document
    .querySelector(
      '.settings-box .option-box:nth-of-type(3) button[data-bullets="yes"]'
    )
    .classList.add("active");
...
document.addEventListener("DOMContentLoaded", function () {
  function updateImageDisplay() {
    ...
    document
      .querySelectorAll(".gallery .bullets span")
...
window.addEventListener("scroll", function () {
  if (scrollY >= timelineSection.offsetTop - 200) {
    ...
    let divs2 = document.querySelectorAll(
...
let current = 0;
const boxes = [
  document.querySelector(".ahmed"),
  document.querySelector(".ali"),
  document.querySelector(".Amr"),
];
